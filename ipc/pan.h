...
#define _nstates0	178	/* thread */
#define minseq0	0
#define maxseq0	176
#define _endstate0	177
...
struct IPC_Prm { /* user defined type */
	unsigned has_receive_part : 1;
	unsigned open_wait : 1;
	short partner;
	unsigned has_send_part : 1;
};
struct IPC_State { /* user defined type */
	unsigned ready : 1;
	unsigned receiving : 1;
	unsigned polling : 1;
	unsigned ipc_in_progress : 1;
	unsigned send_in_progress : 1;
	unsigned busy : 1;
	unsigned cancel : 1;
	unsigned polling_long : 1;
	unsigned busy_long : 1;
	unsigned rcvlong_in_progress : 1;
};
struct IPC_Output { /* user defined type */
	short error;
	short dope;
	unsigned msg_copied : 1;
	short rcv_source;
};
struct Sender_List { /* user defined type */
	short snd_ls[2];
	uchar last_index;
};
#define Pthread	((P0 *)_this)
...
#endif
	unsigned have_sender : 1;
	unsigned _5_3_ds1_in_snd_ls : 1;
	unsigned _5_3_in_snd_ls : 1;
	uchar _5_3_ds1_i;
	uchar _5_3_i;
	short sender;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, sender) - 1*sizeof(short))
...
typedef struct State {
	...
	#endif
#endif
	short ipc_lock_owner[2];
	struct IPC_Prm ipc_g_prm[2];
	struct IPC_State ipc_state[2];
	struct IPC_Output ipc_output[2];
	struct Sender_List sender_ls[2];
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	short rcv_partner[2];
/* hidden variable: */	short snd_partner[2];

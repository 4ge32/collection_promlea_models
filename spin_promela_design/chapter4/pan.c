...
iniglobals(int calling_pid)
{
		...
		state2 = 3;
#ifdef VAR_RANGES
		logval("mutex1", now.mutex1);
		logval("mutex2", now.mutex2);
#endif
}
...
{	/* int i; */
	...
	printf("	mtype  BLUE:	4\n");
	printf("	mtype  RED:	3\n");
	printf("	mtype  LOCKED:	2\n");
	printf("	mtype  UNLOCKED:	1\n");
	printf("	mtype  mutex1:	%d\n", now.mutex1);
	printf("	mtype  mutex2:	%d\n", now.mutex2);
}
void
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("UNLOCKED"); return;
	case 2: Printf("LOCKED"); return;
	case 3: Printf("RED"); return;
	case 4: Printf("BLUE"); return;

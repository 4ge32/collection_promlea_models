...
#define _nstates1	13	/* signal2 */
#define minseq1	12
#define maxseq1	23
#define _endstate1	12

#define _nstates0	13	/* signal1 */
#define minseq0	0
#define maxseq0	11
...
#define Psignal2	((P1 *)_this)
typedef struct P1 { /* signal2 */
...
#define Psignal1	((P0 *)_this)
typedef struct P0 { /* signal1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	uchar state1;
/* hidden variable: */	uchar state2;
